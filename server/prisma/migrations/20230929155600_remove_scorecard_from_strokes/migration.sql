...
INSERT INTO "new_strokeLog" ("club_id", "date_created", "date_updated", "direction", "distance", "golfer_id", "green", "hole_id", "penalty", "pickup", "round_id", "stroke_number") SELECT "club_id", "date_created", "date_updated", "direction", "distance", "golfer_id", "green", "hole_id", "penalty", "pickup", "round_id", "stroke_number" FROM "strokeLog";
